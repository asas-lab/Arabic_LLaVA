...
from modeling_jais import JAISModel, JAISLMHeadModel
...
class LlavajaisForCausalLM(JAISLMHeadModel, LlavaMetaForCausalLM):
    config_class = LlavajaisForCausalLM
...
AutoConfig.register("llava_jais", LlavahfConfig)
